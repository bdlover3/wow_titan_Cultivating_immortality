...
| `GetQuestInfo(questID)` | `C_QuestLog.GetQuestLogTitle()` / `C_QuestLog.GetSelectedQuest()` |
...
### 新 Settings API（正式服风格）
    ...
    Settings.CreateSlider(category, alphaSetting, Settings.CreateSliderOptions(0, 1, 0.01), "透明度")
